      ...
      <div className='card-block w-[400px] -mt-20'> 
          ...
          <form >
            <div className="">
              ...
              <input type="text" placeholder='Username' name="username" className="form-input" required/>
            </div>
            <div className="mb-4">
              <label className="form-label">Password</label>
              <input type="text" placeholder='Password' name="password"  className="form-input" required/>
            </div>
